...
import { ContentBlockImageFullProps } from '../ContentBlocks.types';

/**
 * ContentBlocksImageFull Component
 */
const ContentBlocksImageFull: React.FC<ContentBlockImageFullProps> = ({
  block,
}) => (
  <div className="ContentBlocksImageFull">
    <picture>
      <source
        type="image/webp"
        srcSet={`${block.image.sizes.fullWidth1800}.webp 1x,
      ...
      <source
        type="image/jpeg"
        srcSet={`${block.image.sizes.fullWidth1800} 1x,
      ...
      <source
        type="image/webp"
        srcSet={`${block.image.sizes.fullWidth1024}.webp 1x,
      ...
      <source
        type="image/jpeg"
        srcSet={`${block.image.sizes.fullWidth1024} 1x,
      ...
      <source
        type="image/webp"
        srcSet={`${block.image.sizes.fullWidth768}.webp 1x,
      ...
      <source
        type="image/jpeg"
        srcSet={`${block.image.sizes.fullWidth768} 1x,
      ...
      <source
        type="image/webp"
        srcSet={`${block.image.sizes.fullWidth481}.webp 1x,
          ${block.image.sizes.fullWidth481_2x}.webp 1.5x,
          ${block.image.sizes.fullWidth481_2x}.webp 2x`}
      />
      <img
        srcSet={`${block.image.sizes.fullWidth481} 1x,
