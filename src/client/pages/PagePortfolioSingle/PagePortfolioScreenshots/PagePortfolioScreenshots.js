 ...
 *
 * @name PagePortfolioScreenshots
 * @param {array} props.screenshots - The screenshots
 * @return {JSXElement}
 */
const PagePortfolioScreenshots = ({
   ...
   *
   * @name  openLightboxOnSlide
   * @type  {function} with memoized useCallback to update when lightboxController.toggler changes
   * @param {event} e Event
   * @param {number} index the selected screenshots index
   */
